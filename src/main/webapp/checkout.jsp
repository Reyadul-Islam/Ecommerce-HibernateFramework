        ...
        <div class="container">
            <div class="row mt-5">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card mb-5">
                        <div class="card-body">
                            <h3 class="text-center mb-5">Your details for orders</h3>
                            <form action="#!">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<%= user.getUserPhone()%>" type="number" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Enter your contact">

                                </div>
                                    
                                <div class="form-group">
                                    <label for="text">Your shipping address:</label>
